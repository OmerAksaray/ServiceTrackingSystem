...
namespace ServiceTrackingSystem.Migrations
{
    ...
    [Migration("20250131143123_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EmployeeRouteAssignment", b =>
                {
                    b.Property<string>("EmployeesId")
                        .HasColumnType("nvarchar(450)");

                    b.Property<int>("RouteAssignmentsId")
                        .HasColumnType("int");

                    b.HasKey("EmployeesId", "RouteAssignmentsId");

                    b.HasIndex("RouteAssignmentsId");

                    b.ToTable("EmployeeRouteAssignment");
                });
            ...
            modelBuilder.Entity("EmployeeRouteAssignment", b =>
                {
                    ...
                    b.HasOne("ServiceTrackingSystem.Models.RouteAssignment", null)
                        .WithMany()
                        .HasForeignKey("RouteAssignmentsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
