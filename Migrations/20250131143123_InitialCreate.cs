        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_EmployeeAddresses_AspNetUsers_EmployeeId1",
            ...
            migrationBuilder.CreateTable(
                name: "EmployeeRouteAssignment",
                columns: table => new
                {
                    EmployeesId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    RouteAssignmentsId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_EmployeeRouteAssignment", x => new { x.EmployeesId, x.RouteAssignmentsId });
                    table.ForeignKey(
                        name: "FK_EmployeeRouteAssignment_AspNetUsers_EmployeesId",
                        column: x => x.EmployeesId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_EmployeeRouteAssignment_RouteAssignments_RouteAssignmentsId",
                        column: x => x.RouteAssignmentsId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EmployeeRouteAssignment_RouteAssignmentsId",
                table: "EmployeeRouteAssignment",
                column: "RouteAssignmentsId");
